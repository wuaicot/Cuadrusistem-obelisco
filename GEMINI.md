...
-   **Descripción del proyecto:**  con cargar un archivo PNG del reporte Z (una foto)pueda calcularse el inventario de produccion, con base a unas planillas (Planilla Cocina y Planilla Caja) cuya interfaz sera diseñada para que el usuario haga tap en la regilla del producto, pueda indicar el valor o la cantidad en un sistema que se lee de izquierda a derecha y de arrima a abajo.. 
