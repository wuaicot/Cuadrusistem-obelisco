...
export const BEBESTIBLES: Record<string, BebestibleDef> = {
  '4101': {
    codigo: '4101',
    nombre: 'Cerveza lata Austral 1/2 lt',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4201': {
    codigo: '4201',
    nombre: 'Cerv Cristal ret 1 Lt',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4202': {
    codigo: '4202',
    nombre: 'Cerv Escudo Ret 1 Lt',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4203': {
  ...
  '4209': {
    codigo: '4209',
    nombre: 'Cerveza botella Royal 355cc',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4211': {
    codigo: '4211',
    nombre: 'Cerveza Torobayo 1/2 lt',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4215': {
    codigo: '4215',
    nombre: 'Cerveza lata pers. Cristal',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4217': {
  ...
  '4219': {
    codigo: '4219',
    nombre: 'Cerveza lata escudo 1/2 lt',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4220': {
    codigo: '4220',
    nombre: 'Cerveza lata Cristal 1/2 lt',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4221': {
    codigo: '4221',
    nombre: 'SCHOP QUILMES 500 CC',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4224': {
    codigo: '4224',
    nombre: 'BOTELLIN HEINEKEN',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4228': {
    codigo: '4228',
    nombre: 'Cerveza Sol botellín',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4230': {
    codigo: '4230',
    nombre: 'SHOP CRISTAL 500CC',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4232': {
    codigo: '4232',
    nombre: 'HEINIKEN LATA 1/2',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4233': {
    codigo: '4233',
    nombre: 'BOTELLIN ROYAL',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4239': {
    codigo: '4239',
    nombre: 'Cerveza Royal 1/2 lt',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4240': {
  ...
  '4241': {
    codigo: '4241',
    nombre: 'GOLDEN 1/2 LATA',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4245': {
    codigo: '4245',
    nombre: 'Barril Quilmes (tara 11.00)',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4246': {
  ...
  '4313': {
    codigo: '4313',
    nombre: 'Juao nectar individual',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4314': {
    codigo: '4314',
    nombre: 'MONSTER BEBIDA ENERG',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4315': {
  ...
  '4401': {
    codigo: '4401',
    nombre: 'COCA COLA 591CC',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4407': {
    codigo: '4407',
    nombre: 'VITAL SIN GAS',
    categoria: 'BAR',
    unidad: 'unidad',
  },
  '4426': {
  ...
  '4504': {
    codigo: '4504',
    nombre: 'Juao nectar 11/2 litros',
    categoria: 'BAR',
    unidad: 'unidad',
  },
...
export const MENUS: Record<string, MenuDef> = {
  ...
  '0201': {
    ...
    nombre: '+PALTA',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Paltas', cantidad: 1 }],
  },
  '0205': {
    codigo: '0205',
    nombre: '+HUEVO',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Huevos', cantidad: 2 }],
  },
  '0211': {
    codigo: '0211',
    nombre: '+QUESO',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Queso laminado', cantidad: 3 }],
  },
  '0301': {
    codigo: '0301',
  ...
  '0405': {
    ...
    nombre: '+HUEVO',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Huevos', cantidad: 1 }],
  },
  '0411': {
    codigo: '0411',
    nombre: '+QUESO',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Queso laminado', cantidad: 2 }],
  },
  '1005': {
    codigo: '1005',
    nombre: '+HUEVO',
  ...
  '1019': {
    ...
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Carne churrasco gig', cantidad: 1 }],
  },
  ...
  '1213': {
    ...
    nombre: '+TOCINO',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Tocino', cantidad: 1 }],
  },
  '1219': {
    codigo: '1219',
    nombre: 'EXTRA CARNE PERSONAL',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Carne churrasco pers.', cantidad: 1 }],
  },
  ...
  '1315': {
    ...
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Carne lomo pers.', cantidad: 1 }],
  },
  ...
  '2416': {
    ...
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Hamburg KING K', cantidad: 1 }],
  },
  ...
  '3704': {
    ...
    nombre: 'ENSALADA AVE',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Carne Ave .Gigante', cantidad: 1 }],
  },
  '3705': {
    codigo: '3705',
    nombre: 'ENSALADA ATUN',
    categoria: 'COCINA',
    ingredientes: [{ nombre: 'Atún', cantidad: 1 }],
  },
  ...
  '5201': {
    ...
    categoria: 'COCINA',
    ingredientes: [
      { nombre: 'Tortilla De Wrap', cantidad: 1 },
      { nombre: 'Carne Ave Personal', cantidad: 1 },
      { nombre: 'Papas personal 150gr', cantidad: 1 },
    ],
  },
...
export const EMPANADAS: Record<string, EmpanadaDef> = {
  '3508': {
    ...
    categoria: 'EMPANADAS',
    ingredientes: [{ nombre: 'Emp. Horno Pino Carne', cantidad: 1 }],
  },
  '3510': {
    codigo: '3510',
    nombre: 'EMP PINO MARISCO HOR',
    categoria: 'EMPANADAS',
    ingredientes: [{ nombre: 'Emp. Horno marisco', cantidad: 1 }],
  },
  '3601': {
    codigo: '3601',
